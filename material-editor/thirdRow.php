<div class=" btn-group btn-group-justified">
    ...
    <a class="btn btn-primary" onclick="addClass('fa-flip-horizontal',this)" data-toggle="collapse">
        H flip</a>
    <a class="btn btn-primary" onclick="addClass('fa-flip-vertical',this)" data-toggle="collapse">V flip</a>
...
<div id="accordion">
    <div class="panel panel-default">
                        ...
                        <div class="col-md-4 col-sm-4 col-lg-4">
                            <div class="border-style">
                                ...
                                <label>
                                    ...
                                    <input value="5" id="xOffsetValue" class="form-control material-input-text"
                                        type="text">
                                </label>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-4 col-lg-4">
                            <div class="border-style">
                                ...
                                <label>
                                    ...
                                    <input value="5" id="yOffsetValue" class="form-control material-input-text"
                                        type="text">
                                </label>
                            </div>
                            ...
                            <div class="border-style">
                                ...
                                <label>
                                    <input id="blur-radius" style="width:100%" type="range" min="0" max="10"
                                        step="0.1" />
                                    <input value="5" id="blurRadiusValue" class="form-control material-input-text"
                                        type="text">
                                </label>
                            </div>
                            ...
                            <div class="border-style">
                                ...
                                <label>
                                    <input id="spread-radius" style="width:100%" type="range" min="0" max="10"
                                        step="0.1" />
                                    <input value="4" id="spreadRadiusValue" class="form-control material-input-text"
                                        type="text">
                                </label>
                            </div>
                            ...
                            <div
                                ...
                                <label class="" for="picker-5">
                                    <img src="./image/colorpkr.png" style="border-radius:1.1rem;"
                                        class="material-input-text" alt="Italian Trulli">
                                    <input type="color" class=" material-color-picker" id="picker-5" name="favcolor"
                                        value="#ff0000">
                                </label>
        ...
        <div id="collapse2" class="panel-collapse collapse" data-parent="#accordion" aria-expanded="true">
            <div class="panel-body" style="padding-bottom:0">
                            ...
                            <div class="border-style">
                                ...
                                <label>
                                    <input id="iconXoffset" style="width:100%" type="range" min="-20" max="20"
                                        step="0.1">
                                    <input value="5" id="iconXOffsetValue" class="form-control  material-input-text"
                                        type="text">
                                </label>
                            </div>
                        </div>
                            ...
                            <div class="border-style">
                                ...
                                <label>
                                    <input id="iconYoffset" style="width:100%" type="range" min="-20" max="20"
                                        step="0.1">
                                    <input value="5" id="iconYOffsetValue" class="form-control  material-input-text"
                                        type="text">
                                </label>
                            </div>
                        </div>
                            ...
                            <div class="border-style">
                                ...
                                <label>
                                    <input id="icon-blur-radius" style="width:100%" type="range" min="0" max="20"
                                        step="0.1">
                                    <input value="5" id="iconBlurRadiusValue" class="form-control  material-input-text"
                                        type="text">
                                    <label for="picker-6" style="border:none;padding:0;margin-left:15px">
                                        <img src="./image/colorpkr.png" class=" material-input-text"
                                            style="border-radius:1.1rem;" alt="Italian Trulli">
                                        <input type="color" class=" material-color-picker" id="picker-6" name="favcolor"
                                            value="#ff0000">
                                    </label>
                                </label>
                            </div>
        ...
        <div id="collapse3" class="panel-collapse collapse" data-parent="#accordion" aria-expanded="false"
            ...
            <div class="panel-body" style="padding-bottom:0;">
                <div class="btn-group btn-group-justified" role="group" aria-label="Button group with nested dropdown"
                    ...
                    <a type="button" class="btn  btn-default" onclick="materialSetBorder('solid',this)">
                        Solid
                    </a>
                    <a type="button" class="btn  btn-default" onclick="materialSetBorder('dotted',this)">
                        Dotted
                    </a>
                    <a type="button" class="btn btn-default" onclick="materialSetBorder('dashed',this)">
                        Dashed
                    </a>
                    <a type="button" class="btn btn-default" onclick="materialSetBorder('double',this)">
                        Double
                    </a>
                    <a type="button" class="btn  btn-default" onclick="materialSetBorder('groove',this)">
                        Groove
                    </a>
                    <a type="button" class="btn btn-default" onclick="materialSetBorder('ridge',this)">
                        Ridge
                    </a>
                    <a type="button" class="btn btn-default" onclick="materialSetBorder('inset',this)">
                        inset
                    </a>
                    <a type="button" class="btn btn-default" onclick="materialSetBorder('outset',this)">
                        outset
                    </a>
                    <a type="button" class="btn btn-default" onclick="materialSetBorder('hidden',this)">
                        hidden
                    </a>
                </div>
                    ...
                    <div class="col-sm-4 col-lg-4 col-md-4">
                        <div class="border-style">
                            ...
                            <label>
                                ...
                                <input value="0" id="iconPaddingValue" class="form-control  material-input-text"
                                    type="text">
                            </label>
                        </div>
                    </div>
                    <div class=" col-sm-4">
                        <div class="border-style">
                            ...
                            <label>
                                ...
                                <input value="100" id="iconRadiusValue" class="form-control  material-input-text"
                                    type="text">
                            </label>
                        </div>
                    </div>
                        ...
                        <div class="border-style">
                            ...
                            <label>
                                <input id="outlineStroke" style="width:100%" type="range" value="5" min="1" max="15"
                                    step="1">
                                <input value="5" id="outlineStrokeValue" class="form-control  material-input-text"
                                    type="text">
                            </label>
                        </div>
                    </div>
                ...
                <div style="justify-content: space-between;display:flex;flex-wrap:wrap">
                    <button class="btn  material-rounded-btn ffffff" style="width:3rem;height:3rem"
                        onclick="setBorderColor('#ffffff',this);"></button>
                    <button class="btn  material-rounded-btn gray" style="width:3rem; height:3rem"
                        onclick="setBorderColor('#808080',this);"></button>
                    <button class="btn  material-rounded-btn darkgray" style="width:3rem; height:3rem"
                        onclick="setBorderColor('#545454',this);"></button>
                    <button class="btn  material-rounded-btn black" style="width:3rem; height:3rem"
                        onclick="setBorderColor('#000000',this);"></button>
                    <button class="btn  material-rounded-btn ed5f1e" style="width:3rem; height:3rem"
                        onclick="setBorderColor('#ed5f1e',this);"></button>
                    <button class="btn  material-rounded-btn orange" style="width:3rem; height:3rem"
                        onclick="setBorderColor('#f39c12',this);"></button>
                    <button class="btn  material-rounded-btn yellow" style="width:3rem; height:3rem"
                        onclick="setBorderColor('#ffd230',this);"></button>
                    <button class="btn  material-rounded-btn deepgreen" style="width:3rem; height:3rem"
                        onclick="setBorderColor('#008037',this);"></button>
                    <button class="btn  material-rounded-btn navyblue" style="width:3rem; height:3rem"
                        onclick="setBorderColor('#000080',this);"></button>
                    <button class="btn  material-rounded-btn blue" style="width:3rem; height:3rem"
                        onclick="setBorderColor('#0000ff',this);"></button>
                    <button class="btn  material-rounded-btn purple" style="width:3rem; height:3rem"
                        onclick="setBorderColor('#800080',this);"></button>
                    <button class="btn  material-rounded-btn brown" style="width:3rem; height:3rem"
                        onclick="setBorderColor('#a52a2a',this);"></button>
                    <button class="btn  material-rounded-btn red" style="width:3rem; height:3rem"
                        onclick="setBorderColor('#ff0000',this);"></button>
                    <button class="btn  material-rounded-btn a83232" style="width:3rem; height:3rem"
                    ...
                    <div class="col-sm-4">
                        <div class="border-style">
                            ...
                            <label>
                                ...
                                <input value="25" id="backgroundPaddingValue" class="form-control  material-input-text"
                                    type="text">
                            </label>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="border-style">
                            ...
                            <label>
                                ...
                                <input value="25" id="backgroundRadiusValue" class="form-control  material-input-text"
                                    type="text">
                            </label>
                        </div>
                    </div>
                        ...
                        <div class="border-style">
                            ...
                            <label>
                                <input id="backgroundStroke" value="15" style="width:100%" type="range" min="0" max="15"
                                    step="0.1">
                                <input value="15" id="backgroundStrokeValue" class="form-control  material-input-text"
                                    type="text">
