...
<div id="accordion">
    <div class="panel panel-default">
        <div id="collapse1" class="panel-collapse collapse in" data-parent="#accordion" aria-expanded="true">
                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-4 col-lg-4">
                            <div class="svg-input-border">
                                ...
                                <label>
                                    ...
                                    <input value="5" id="" class="form-control svg-input-text" type="text">
                                </label>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-4 col-lg-4">
                            <div class="svg-input-border">
                                ...
                                <label>
                                    ...
                                    <input value="5" id="yOffsetValue" class="form-control svg-input-text" type="text">
                                </label>
                            </div>
                        ...
                        <div class="col-md-4 col-sm-4 col-lg-4">
                            <div class="svg-input-border">
                                <p>Blur</p>
                                <label>
                                    <input id="blur-radius" style="width:100%" type="range" min="0" max="10" step="0.1">
                                    <input value="5" id="blurRadiusValue" class="form-control svg-input-text"
                                        type="text">
                                </label>
                            </div>
                            ...
                            <div class="svg-input-border">
                                ...
                                <label>
                                    <input id="spread-radius" style="width:100%" type="range" min="0" max="10"
                                        step="0.1">
                                    <input value="4" id="spreadRadiusValue" class="form-control svg-input-text"
                                        type="text">
                                </label>
                            </div>
                            ...
                            <div class="svg-input-border">
                                ...
                                <label>
                                    <input id="iconXoffset" style="width:100%" type="range" min="-20" max="20"
                                        step="0.1">
                                    <input value="5" id="iconXOffsetValue" class="form-control svg-input-text"
                                        type="text">
                                </label>
                            </div>
                        </div>
                            ...
                            <div class="svg-input-border">
                                ...
                                <label>
                                    <input id="iconYoffset" style="width:100%" type="range" min="-20" max="20"
                                        step="0.1">
                                    <input value="5" id="iconYOffsetValue" class="form-control svg-input-text"
                                        type="text">
                                </label>
                            </div>
                        </div>
                            ...
                            <div class="svg-input-border">
                                ...
                                <label>
                                    <input id="icon-blur-radius" style="width:100%" type="range" min="0" max="20"
                                        step="0.1">
                                    <input value="5" id="iconBlurRadiusValue" class="form-control svg-input-text"
                                        type="text">
        ...
        <div id="collapse3" class="panel-collapse collapse" data-parent="#accordion" aria-expanded="false"
            ...
            <div class="panel-body" style="padding-bottom:0;">
                    ...
                    <div class="col-sm-4 col-lg-4 col-md-4">
                        <div class="svg-input-border">
                            ...
                            <label>
                                ...
                                <input value="0" id="iconPaddingValue" class="form-control svg-input-text" type="text">
                            </label>
                        </div>
                    </div>
                    <div class=" col-sm-4">
                        <div class="svg-input-border">
                            ...
                            <label>
                                ...
                                <input value="100" id="iconRadiusValue" class="form-control svg-input-text" type="text">
                            </label>
                        </div>
                    </div>
                    <div class=" col-sm-4 ">
                        <div class="svg-input-border">
                            ...
                            <label>
                                <input id="outlineStroke" style="width:100%" type="range" value="5" min="1" max="15"
                                    step="1">
                                <input value="5" id="outlineStrokeValue" class="form-control svg-input-text"
                                    type="text">
                            </label>
                        </div>
                    </div>
                ...
                <div style="justify-content: space-between;display:flex;flex-wrap:wrap">
                    <button class="btn rounded-btn ffffff" style="width:3rem;height:3rem"
                        onclick="setBorderColor('#ffffff',this);"></button>
                    <button class="btn rounded-btn gray" style="width:3rem; height:3rem"
                        onclick="setBorderColor('#808080',this);"></button>
                    <button class="btn rounded-btn darkgray" style="width:3rem; height:3rem"
                        onclick="setBorderColor('#545454',this);"></button>
                    <button class="btn rounded-btn black" style="width:3rem; height:3rem"
                        onclick="setBorderColor('#000000',this);"></button>
                    <button class="btn rounded-btn ed5f1e" style="width:3rem; height:3rem"
                        onclick="setBorderColor('#ed5f1e',this);"></button>
                    <button class="btn rounded-btn orange" style="width:3rem; height:3rem"
                        onclick="setBorderColor('#f39c12',this);"></button>
                    <button class="btn rounded-btn yellow" style="width:3rem; height:3rem"
                        onclick="setBorderColor('#ffd230',this);"></button>
                    <button class="btn rounded-btn deepgreen" style="width:3rem; height:3rem"
                        onclick="setBorderColor('#008037',this);"></button>
                    <button class="btn rounded-btn navyblue" style="width:3rem; height:3rem"
                        onclick="setBorderColor('#000080',this);"></button>
                    <button class="btn rounded-btn blue" style="width:3rem; height:3rem"
                        onclick="setBorderColor('#0000ff',this);"></button>
                    <button class="btn rounded-btn purple" style="width:3rem; height:3rem"
                        onclick="setBorderColor('#800080',this);"></button>
                    <button class="btn rounded-btn brown" style="width:3rem; height:3rem"
                        onclick="setBorderColor('#a52a2a',this);"></button>
                    <button class="btn rounded-btn red" style="width:3rem; height:3rem"
                        onclick="setBorderColor('#ff0000',this);"></button>
                    <button class="btn rounded-btn a83232" style="width:3rem; height:3rem"
        ...
        <div id="collapse4" class="panel-collapse collapse" data-parent="#accordion" aria-expanded="false"
            ...
            <div class="panel-body" style="padding-bottom:0">
                    ...
                    <div class="col-sm-4">
                        <div class="svg-input-border">
                            ...
                            <label>
                                ...
                                <input value="25" id="backgroundPaddingValue" class="form-control svg-input-text"
                                    type="text">
                            </label>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="svg-input-border">
                            ...
                            <label>
                                ...
                                <input value="25" id="backgroundRadiusValue" class="form-control svg-input-text"
                                    type="text">
                            </label>
                        </div>
                    </div>
                        ...
                        <div class="svg-input-border">
                            ...
                            <label>
                                <input id="backgroundStroke" value="15" style="width:100%" type="range" min="0" max="15"
                                    step="0.1">
                                <input value="15" id="backgroundStrokeValue" class="form-control svg-input-text"
                                    type="text">
                ...
                <div style="justify-content: space-between;display:flex;flex-wrap:wrap">
                    ...
                    <a class="btn btn-default" id="removeShape">Remove</a>
                </div>
            </div>
        </div>
    </div>
